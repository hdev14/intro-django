...
class QuestionModelTest(TestCase):
	def test_was_published_rencently_with_future_question(self):
		"""
		was_published_recently() returns Dalse for questions whose publication_date
		is in the future.
		"""
	...
	def create_question(question_text, days):
		...
		number of 'days' offset to now (negative for questons published in the
...
class QuestionIndexViewTests(TestCase):
	...
	def test_past_question(self):
		"""
		Questions with a publication_date in the past are displayed on the index page.
		"""
	...
	def test_future_question(self):
		"""
		Question with a publication_date in the future aren't displayed on the index page.
		"""
